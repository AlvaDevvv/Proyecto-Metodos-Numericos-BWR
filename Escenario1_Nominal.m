% =========================================================================
% Archivo: Escenario1_Nominal.m
% Descripción: Operación a plena potencia. El reactor se calienta desde 
% 600 K hasta alcanzar su perfil de temperatura estacionario.
% =========================================================================
clear; clc; close all;
...
% 2. Sobrescritura Local de Parámetros (Escenario 1)
q_gen = 3e8;    % Generación nominal de calor
h_inf = 50000;  % Refrigeración nominal
T_inf = 560;    
T_ini = 600;    % Arranca frío
...
title('Escenario 1: Operación Nominal');
